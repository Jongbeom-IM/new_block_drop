...
def test():
    ...
    print(log_str)
    return accuracy, sparsity, variance, ops_mean, ops_std, len(policy_set)

#--------------------------------------------------------------------------------------------------------#``

def log(accuracy, sparsity, variance, ops_mean, ops_std, len):
    filename = "log_" + args.load.split("/")[-1] + ".csv"
...
accuracy, sparsity, variance, ops_mean, ops_std, len = test()
log(accuracy, sparsity, variance, ops_mean, ops_std, len)
